...
(define htree-rock (generate-huffman-tree '((A 2) (NA 16) (BOOM 1) (SHA 3) (GET 2) (YIP 9) (JOB 2) (WAH 1))))
(print-huffman-tree htree-rock)
(newline)

(display (encode '(GET A JOB) htree-rock))
(newline)
(display (encode '(SHA NA NA NA NA NA NA NA NA) htree-rock))
(newline)
(display (encode '(GET A JOB) htree-rock))
(newline)
(display (encode '(SHA NA NA NA NA NA NA NA NA) htree-rock))
(newline)
(display (encode '(WAH YIP YIP YIP YIP YIP YIP YIP YIP YIP) htree-rock))
(newline)
(display (encode '(SHA BOOM) htree-rock))
(newline)
